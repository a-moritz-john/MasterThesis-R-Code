...
semtree <- function(model, data = NULL, control = NULL, constraints = NULL,
  ...
  #  }
  #}
  ## Changes form Moritz J.: Data does not need to be complete to use score-tests; Calculation is implemented in lavaan
...
#    print("Focus parameters are now supported with OpenMx!")
#}

## Changes from Moritz J.
